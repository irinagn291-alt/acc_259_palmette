...
- Invariant (unit-test this): progress = current/target. Milestones 0.25/0.5/0.75/1.0. vineSeed drives branch shape. Manual only — no bank.
- Empty: The garden is empty. Plant your first goal.
- Fake that fails: A savings list or bank graph.
